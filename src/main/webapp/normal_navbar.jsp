  ...
  <a class="navbar-brand" href="index.jsp"><span class="fa fa-angellist "></span> TechBlog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><span class="fa fa-genderless"></span> Learn Code easily <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link " href="registration_page.jsp"><span class="fa fa-smile-o"></span> Register</a>
      </li>
    </ul>
